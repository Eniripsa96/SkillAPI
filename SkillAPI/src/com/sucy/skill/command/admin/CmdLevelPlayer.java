...
public class CmdLevelPlayer implements ICommand {
    ...
    public String getArgsString(Plugin plugin) {
        return ((SkillAPI)plugin).getMessage(CommandNodes.ARGUMENTS + CommandNodes.LEVEL_PLAYER, true);
    }
    ...
    public String getDescription(Plugin plugin) {
        return ((SkillAPI)plugin).getMessage(CommandNodes.DESCRIPTION + CommandNodes.LEVEL_PLAYER, true);
    }
