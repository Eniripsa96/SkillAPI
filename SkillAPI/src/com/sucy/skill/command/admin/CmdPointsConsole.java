...
public class CmdPointsConsole implements ICommand {
    ...
    public void execute(CommandHandler handler, Plugin plugin, CommandSender sender, String[] args) {
        ...
        if (args.length >= 2) {
            ...
            // Give them the levels
                ...
                List<String> messages = api.getMessages(CommandNodes.COMPLETE + CommandNodes.POINTS_CONSOLE, true);
    ...
    public String getArgsString(Plugin plugin) {
        return ((SkillAPI)plugin).getMessage(CommandNodes.ARGUMENTS + CommandNodes.POINTS_CONSOLE, true);
    }
    ...
    public String getDescription(Plugin plugin) {
        return ((SkillAPI)plugin).getMessage(CommandNodes.DESCRIPTION + CommandNodes.POINTS_CONSOLE, true);
    }
