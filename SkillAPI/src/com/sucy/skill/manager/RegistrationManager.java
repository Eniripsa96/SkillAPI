...
public class RegistrationManager
{
     ...
     */
    public enum Mode { STARTUP, SKILL, CLASS, DONE }
    ...
    public Skill validate(Skill skill) {
        ...
        if (mode != Mode.SKILL) throw new IllegalStateException("Skills cannot be added outside the provided SkillPlugin method");
    ...
    public RPGClass validate(RPGClass rpgClass) {
        ...
        // Cannot register outside the allotted time
        if (mode != Mode.CLASS) throw new IllegalStateException("Classes cannot be added outside the provided SkillPlugin method");

        // Cannot be null
        else if (rpgClass == null) throw new IllegalArgumentException("Cannot register a null class");
