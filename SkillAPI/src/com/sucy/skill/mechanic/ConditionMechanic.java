    ...
    public boolean resolve(Player player, PlayerSkills data, DynamicSkill skill, Target target, List<LivingEntity> targets) {
        ...
        for (LivingEntity t : targets) {
            ...
            do {
                ...
                else if (VersionManager.isVersionAtLeast(VersionManager.MC_1_6_2_MIN) && condition == HEALTH && t.hasPotionEffect(PotionEffectType.HEALTH_BOOST)) passed = true;
                else if (VersionManager.isVersionAtLeast(VersionManager.MC_1_6_2_MIN) && condition == ABSORPTION && t.hasPotionEffect(PotionEffectType.ABSORPTION)) passed = true;
                else if (VersionManager.isVersionAtLeast(VersionManager.MC_1_6_2_MIN) && condition == SATURATION && t.hasPotionEffect(PotionEffectType.SATURATION)) passed = true;
