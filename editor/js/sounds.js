...
for (var i = 0; i < SOUNDS_POST.length; i++) 
    SOUNDS_POST[i] = formatSound(SOUNDS_POST[i]);
for (var i = 0; i < SOUNDS_PRE.length; i++) 
    SOUNDS_PRE[i] = formatSound(SOUNDS_PRE[i]);

function formatSound(name) {
