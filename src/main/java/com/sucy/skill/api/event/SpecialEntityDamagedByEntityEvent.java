 ...
 */
public class SpecialEntityDamagedByEntityEvent extends Event {
     ...
     *
     * @param defender entity taking damage
     * @param attacker entity dealing damage
     * @param type    type of attack
     * @param damage  amount of damage dealt
     */
    public SpecialEntityDamagedByEntityEvent(LivingEntity defender, LivingEntity attacker, AttackType type, double damage) {
    ...
    /**
     * @return entity that took damage
     */
